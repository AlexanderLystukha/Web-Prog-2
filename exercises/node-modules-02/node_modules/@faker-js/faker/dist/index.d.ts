import { F as Faker, L as LocaleDefinition, R as Randomizer } from '@faker-js/faker/dist/airline-D6ksJFwG.js';
export { r as Aircraft, s as AircraftType, A as AirlineDefinition, t as AirlineModule, a as AnimalDefinition, u as AnimalModule, $ as BitcoinAddressFamily, a1 as BitcoinAddressFamilyType, a0 as BitcoinNetwork, a2 as BitcoinNetworkType, B as BookDefinition, v as BookModule, y as Casing, ak as ChemicalElement, C as ColorDefinition, z as ColorFormat, E as ColorModule, b as CommerceDefinition, O as CommerceModule, c as CommerceProductNameDefinition, d as CompanyDefinition, Q as CompanyModule, w as CssFunction, G as CssFunctionType, x as CssSpace, J as CssSpaceType, Z as Currency, D as DatabaseDefinition, T as DatabaseModule, U as DatatypeModule, e as DateDefinition, f as DateEntryDefinition, X as DateModule, q as FakerOptions, g as FinanceDefinition, _ as FinanceModule, h as FoodDefinition, a3 as FoodModule, a4 as GitModule, H as HackerDefinition, a5 as HackerModule, a6 as HelpersModule, a9 as IPv4Network, aa as IPv4NetworkType, a8 as ImageModule, I as InternetDefinition, ab as InternetModule, i as LocaleEntry, j as LocationDefinition, ac as LocationModule, k as LoremDefinition, ad as LoremModule, M as MetadataDefinition, l as MusicDefinition, ae as MusicModule, N as NumberColorFormat, af as NumberModule, P as PersonDefinition, m as PersonEntryDefinition, ah as PersonModule, aj as PhoneModule, n as PhoneNumberDefinition, S as ScienceDefinition, al as ScienceModule, ag as Sex, ai as SexType, Y as SimpleDateModule, ar as SimpleFaker, a7 as SimpleHelpersModule, K as StringColorFormat, an as StringModule, o as SystemDefinition, p as SystemMimeTypeEntryDefinition, ao as SystemModule, am as Unit, V as VehicleDefinition, ap as VehicleModule, W as WordDefinition, aq as WordModule, as as simpleFaker } from '@faker-js/faker/dist/airline-D6ksJFwG.js';
export { faker, faker as fakerEN } from '@faker-js/faker/dist/locale/en.js';
export { faker as fakerAF_ZA } from '@faker-js/faker/dist/locale/af_ZA.js';
export { faker as fakerAR } from '@faker-js/faker/dist/locale/ar.js';
export { faker as fakerAZ } from '@faker-js/faker/dist/locale/az.js';
export { faker as fakerBASE } from '@faker-js/faker/dist/locale/base.js';
export { faker as fakerCS_CZ } from '@faker-js/faker/dist/locale/cs_CZ.js';
export { faker as fakerDA } from '@faker-js/faker/dist/locale/da.js';
export { faker as fakerDE } from '@faker-js/faker/dist/locale/de.js';
export { faker as fakerDE_AT } from '@faker-js/faker/dist/locale/de_AT.js';
export { faker as fakerDE_CH } from '@faker-js/faker/dist/locale/de_CH.js';
export { faker as fakerDV } from '@faker-js/faker/dist/locale/dv.js';
export { faker as fakerEL } from '@faker-js/faker/dist/locale/el.js';
export { faker as fakerEN_AU } from '@faker-js/faker/dist/locale/en_AU.js';
export { faker as fakerEN_AU_ocker } from '@faker-js/faker/dist/locale/en_AU_ocker.js';
export { faker as fakerEN_BORK } from '@faker-js/faker/dist/locale/en_BORK.js';
export { faker as fakerEN_CA } from '@faker-js/faker/dist/locale/en_CA.js';
export { faker as fakerEN_GB } from '@faker-js/faker/dist/locale/en_GB.js';
export { faker as fakerEN_GH } from '@faker-js/faker/dist/locale/en_GH.js';
export { faker as fakerEN_HK } from '@faker-js/faker/dist/locale/en_HK.js';
export { faker as fakerEN_IE } from '@faker-js/faker/dist/locale/en_IE.js';
export { faker as fakerEN_IN } from '@faker-js/faker/dist/locale/en_IN.js';
export { faker as fakerEN_NG } from '@faker-js/faker/dist/locale/en_NG.js';
export { faker as fakerEN_US } from '@faker-js/faker/dist/locale/en_US.js';
export { faker as fakerEN_ZA } from '@faker-js/faker/dist/locale/en_ZA.js';
export { faker as fakerEO } from '@faker-js/faker/dist/locale/eo.js';
export { faker as fakerES } from '@faker-js/faker/dist/locale/es.js';
export { faker as fakerES_MX } from '@faker-js/faker/dist/locale/es_MX.js';
export { faker as fakerFA } from '@faker-js/faker/dist/locale/fa.js';
export { faker as fakerFI } from '@faker-js/faker/dist/locale/fi.js';
export { faker as fakerFR } from '@faker-js/faker/dist/locale/fr.js';
export { faker as fakerFR_BE } from '@faker-js/faker/dist/locale/fr_BE.js';
export { faker as fakerFR_CA } from '@faker-js/faker/dist/locale/fr_CA.js';
export { faker as fakerFR_CH } from '@faker-js/faker/dist/locale/fr_CH.js';
export { faker as fakerFR_LU } from '@faker-js/faker/dist/locale/fr_LU.js';
export { faker as fakerFR_SN } from '@faker-js/faker/dist/locale/fr_SN.js';
export { faker as fakerHE } from '@faker-js/faker/dist/locale/he.js';
export { faker as fakerHR } from '@faker-js/faker/dist/locale/hr.js';
export { faker as fakerHU } from '@faker-js/faker/dist/locale/hu.js';
export { faker as fakerHY } from '@faker-js/faker/dist/locale/hy.js';
export { faker as fakerID_ID } from '@faker-js/faker/dist/locale/id_ID.js';
export { faker as fakerIT } from '@faker-js/faker/dist/locale/it.js';
export { faker as fakerJA } from '@faker-js/faker/dist/locale/ja.js';
export { faker as fakerKA_GE } from '@faker-js/faker/dist/locale/ka_GE.js';
export { faker as fakerKO } from '@faker-js/faker/dist/locale/ko.js';
export { faker as fakerLV } from '@faker-js/faker/dist/locale/lv.js';
export { faker as fakerMK } from '@faker-js/faker/dist/locale/mk.js';
export { faker as fakerNB_NO } from '@faker-js/faker/dist/locale/nb_NO.js';
export { faker as fakerNE } from '@faker-js/faker/dist/locale/ne.js';
export { faker as fakerNL } from '@faker-js/faker/dist/locale/nl.js';
export { faker as fakerNL_BE } from '@faker-js/faker/dist/locale/nl_BE.js';
export { faker as fakerPL } from '@faker-js/faker/dist/locale/pl.js';
export { faker as fakerPT_BR } from '@faker-js/faker/dist/locale/pt_BR.js';
export { faker as fakerPT_PT } from '@faker-js/faker/dist/locale/pt_PT.js';
export { faker as fakerRO } from '@faker-js/faker/dist/locale/ro.js';
export { faker as fakerRO_MD } from '@faker-js/faker/dist/locale/ro_MD.js';
export { faker as fakerRU } from '@faker-js/faker/dist/locale/ru.js';
export { faker as fakerSK } from '@faker-js/faker/dist/locale/sk.js';
export { faker as fakerSR_RS_latin } from '@faker-js/faker/dist/locale/sr_RS_latin.js';
export { faker as fakerSV } from '@faker-js/faker/dist/locale/sv.js';
export { faker as fakerTH } from '@faker-js/faker/dist/locale/th.js';
export { faker as fakerTR } from '@faker-js/faker/dist/locale/tr.js';
export { faker as fakerUK } from '@faker-js/faker/dist/locale/uk.js';
export { faker as fakerUR } from '@faker-js/faker/dist/locale/ur.js';
export { faker as fakerUZ_UZ_latin } from '@faker-js/faker/dist/locale/uz_UZ_latin.js';
export { faker as fakerVI } from '@faker-js/faker/dist/locale/vi.js';
export { faker as fakerYO_NG } from '@faker-js/faker/dist/locale/yo_NG.js';
export { faker as fakerZH_CN } from '@faker-js/faker/dist/locale/zh_CN.js';
export { faker as fakerZH_TW } from '@faker-js/faker/dist/locale/zh_TW.js';
export { faker as fakerZU_ZA } from '@faker-js/faker/dist/locale/zu_ZA.js';
